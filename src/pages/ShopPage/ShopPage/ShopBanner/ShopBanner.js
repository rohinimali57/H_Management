              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  <div className="row">
                    {/* <SingleShop
                      image="1"
                      speciality={result.result.procedure[0].speciality}
                      pname={result.result.procedure[0].pname}
                      price={result.result.procedure[0].price}
                      discount={result.result.procedure[0].discount}
                    /> */}
